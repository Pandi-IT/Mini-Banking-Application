    ...
    <div class="auth-container fade-in">
      <div class="auth-card glass">
        <div class="auth-header">
          ...
          <p>Register a new Banking Core portal profile</p>
        </div>
        ...
        <form (ngSubmit)="onSubmit()" #registerForm="ngForm" class="auth-form">
          ...
          <div class="form-group">
            ...
            @if (passInput.invalid && (passInput.dirty || passInput.touched)) {
              @if (passInput.errors?.['required']) {
                <span class="error-text">Password is required</span>
              } @else if (passInput.errors?.['minlength']) {
          ...
          <div class="form-group">
            ...
            />
            @if (confirmInput.touched && password !== confirmPassword) {
...
export class Register {
  ...
  onSubmit(): void {
    ...
    this.authService.register(this.fullName, this.email, this.password).subscribe({
      ...
      error: (err) => {
        this.isLoading.set(false);
        const msg = err.error?.message || 'Registration failed. Check if email is already in use.';
